            ...
            <Card>
                ...
                <div className="mt-8 pt-8 border-t border-slate-50 flex items-center justify-between">
                    ...
                    <div className="flex space-x-2">
                        <Button variant="outline" type="button" onClick={() => setPage(p => Math.max(1, p - 1))}>
                            Previous
                        </Button>
                        {Array.from({ length: totalPages }, (_, i) => i + 1).map(p => (
                            <Button key={p} type="button" variant="outline" onClick={() => setPage(p)}>
                                {p}
                            </Button>
                        ))}
                        <Button variant="outline" type="button" onClick={() => setPage(p => Math.min(totalPages, p + 1))}>
                            Next
                        </Button>
                    </div>
                </div>
